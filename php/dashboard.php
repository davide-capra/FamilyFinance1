    ...
    <div class="grid-container">
        ...
        <aside id="sidebar"> 
            <div class="sidebar-brand">
                <img src="../img/Logos.png" alt="Logo del tuo sito web"> <!-- Logo dell applicazione -->
            </div>
            <ul class="sidebar-list"> <!-- Qui Dentro Troviamo Tutte le funzionalità del sito web -->
        ...
        <main class="main-container"><!--Qui Dentro Troviamo una tabella che ci mostra tutti i membri della famiglia -->
            <table class="table">
                <thead>
                    <tr>
                        <h2 style="font-family: 'Dancing Script', cursive;">Lista dei Membri Della tua Famiglia</h2>
